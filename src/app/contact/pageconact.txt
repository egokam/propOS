...
export default function ContactDeveloperPage() {
    ...
    const handleSendMessage = async (e: React.FormEvent) => {
        ...
        // هنا يمكنك لاحقاً ربطها بـ API حقيقي (مثل Brevo أو إرسال إيميل لك)
        // سنقوم بمحاكاة الإرسال بتأخير ثانيتين لرؤية الأنيميشن
        setTimeout(() => {
                        ...
                        <div className="lg:col-span-2 relative group animate-in fade-in slide-in-from-left-8 duration-700 delay-100">
                            ...
                            <div className="relative h-full bg-[#1a1a24] border border-white/10 rounded-2xl p-8 flex flex-col items-center text-center overflow-hidden">
                                ...
                                <div className="w-full space-y-3 mt-auto">
                                    <a href="#" className="flex items-center gap-3 w-full p-3 rounded-xl bg-white/5 border border-white/5 hover:bg-white/10 hover:border-[#02AFA9]/30 transition-all group/btn">
                                        ...
                                        <span className="text-sm font-medium text-white/80 group-hover/btn:text-white transition-colors">GitHub Profile</span>
                                    </a>
                                    <a href="#" className="flex items-center gap-3 w-full p-3 rounded-xl bg-white/5 border border-white/5 hover:bg-white/10 hover:border-[#02AFA9]/30 transition-all group/btn">
                                        <div className="w-8 h-8 rounded-lg bg-[#222231] flex items-center justify-center text-white/50 group-hover/btn:text-[#02AFA9] transition-colors">
                                            <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" /></svg>
                                        </div>
                                        <span className="text-sm font-medium text-white/80 group-hover/btn:text-white transition-colors">contact@egokam.site</span>
                                    </a>
                                </div>
                            </div>
                        </div>
